...
export default function ValuatorClient() {
        ...
        {result && (
          <div className="mt-8 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-baseline justify-between mb-4">
                ...
                <span className="text-xs text-gray-400">
                  Links open targeted search pages
                </span>
              </div>
                  ...
                  >
                    ...
                    <div className="ml-4 flex flex-col items-end shrink-0">
                      ...
                      <a
                        ...
                        title={`View similar listings on ${comp.source}`}
                      >
                        View on {comp.source} →
                      </a>
                    </div>
            ...
            <p className="text-xs text-gray-400 text-center">
              Prices are mock estimates. Comp links open pre-filled search pages
              on third-party sites — not guaranteed exact listings.
            </p>
          </div>
        )}
      </div>
